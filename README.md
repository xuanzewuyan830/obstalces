...
| EMG.v1  | Left Biceps Femoris (BF) 
| EMG.v2  | Left Vastus Lateralis (VL) 
| EMG.v3  | Left Vastus Medialis (VM) 
| EMG.v4  | Left Rectus Femoris (RF) 
| EMG.v5  | Left Peroneus Longus (PL) 
| EMG.v6  | Left Gastrocnemius (GAS) 
| EMG.v7  | Left Tibialis Anterior (TA) 
| EMG.v8  | Left Soleus (SOL) 
| EMG.v9  | Right Biceps Femoris (BF) 
| EMG.v10 | Right Vastus Lateralis (VL) 
| EMG.v11 | Right Vastus Medialis (VM) 
| EMG.v12 | Right Rectus Femoris (RF) 
| EMG.v13 | Right Peroneus Longus (PL) 
| EMG.v14 | Right Gastrocnemius (GAS) 
| EMG.v15 | Right Tibialis Anterior (TA) 
| EMG.v16 | Right Soleus (SOL) 
...
For questions about the data structure, Visual3D workflow, EMG channel definitions, or statistical outputs, please contact:
